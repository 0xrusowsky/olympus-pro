...
BOT_TOKEN = os.environ["DISCORD_BOT_TOKEN_DOLA_3POOL"]
...
def get_prices():
    ...
    bondClosed = maxDebtReached(bond_address='0x8E57A30A3616f65e7d14c264943e77e084Fddd25')
    ...
    bondDisc = bond_discount(bond_address='0x8E57A30A3616f65e7d14c264943e77e084Fddd25', bondPrice=1, payoutTokenPrice=payoutTokenPrice, maxReached=bondClosed, noFunds=bondEmpty)
    ...
    for guild in client.guilds:
        ...
        try:
            if bondDisc == -999:
                ...
                await client.change_presence(activity=discord.Activity(type=discord.ActivityType.playing, name=f'⛔ DOLA-3POOL Bonds'))
            elif bondDisc < 0:
